...
public class ProfileCourses : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //courseTest.title = "Мой первый курс";
        ...
        //courseTest.lessons[2].title = "3. Вроде как третий урок";
        ...
        //    folderText.GetChild(0).GetComponent<Text>().text = courseTest.title;
        ...
        //}
        //folderText.GetChild(1).GetComponent<Text>().text = courseTest.lastLesson.title;
